...
| Metacaractere |    Nome    |              Função               |
| :-----------: | :--------: | :-------------------------------: |
|      \c       |   Escape   | Torna literal o caractere **_c_** |
|      \|       |     Ou     |          Ou um ou outro           |
|     (...)     |   Grupo    |         Delimita um grupo         |
|    \1...\9    | Retrovisor |   Texto casado nos grupos 1...9   |

**_Os curingas usados na linha de comando para especificar nomes de arquivos, como \*.txt, relatorio.{txt, doc} e foto-??.html não são expressões regulares. São curingas específicos de nomes de arquivo._**
...
**_Todos os metacaracteres desse tipo casam a posição de um único caractere, e não mais que um._**
